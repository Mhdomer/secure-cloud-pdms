...
export const REAL_DOCTORS: Doctor[] = [
  ...
  },
  {
    ...
    specialtyEn: 'Dentistry & Dental Care',
  ...
  return [
    {
      ...
      items: [
        ...
        { label: t('nav.howItWorks'), desc: t('nav.howItWorksDesc'), image: '/clinic/reception.png', to: '/patient-info#how-it-works' },
