...
|---|---|---|
| Chapter 3 | §3.5.2 / Appendix D | **DONE 2026-09-16.** NFR-06 (RTO ≤ 15 min) superseded by NFR-06a (infrastructure recovery ≤ 25 min, measured 17m40s) and NFR-06b (full service restoration ≤ 60 min, measured 47m48s). Rationale: RDS Multi-AZ alone takes ~15m11s, and the deploy approval gate is a deliberate control that makes unattended recovery impossible by design. Table D.2 left unchanged as the as-submitted record, with the revision added as **Table D.5**; §3.5.2 narrative and Chapter 5 updated to match |
